package com.example.blockchainmessaging.Fragments;
...
import com.example.blockchainmessaging.BlockChainManager;
import com.example.blockchainmessaging.R;
import com.example.blockchainmessaging.SharedPreferencesManager;
import com.example.blockchainmessaging.databinding.FragmentPowBinding;
        ...
        switch(v.getId()){
            ...
            case R.id.btn_continue:
                if(viewBinding.edtSetPow.getText()!=null){
                    ...
                    BlockChainManager.difficulty=Integer.parseInt(pow);
